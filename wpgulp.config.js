...
const jsCustomSRC = './src/js/custom/custom.js';
...
const zipName = 'uwmemc_child_theme.zip';
...
const textDomain = 'uwmemc';

// Name of the translation file.
const translationFile = 'uwmemc.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'uwmemc';

// Where can users report bugs.
const bugReport = 'https://psistardesigns.com/';

// Last translator Email ID.
const lastTranslator = 'Joseph W. May <jwmay87@gmail.com>';

// Team's Email ID.
const team = 'Joseph W. May <jwmay87@gmail.com>';
