 ...
 *
 * This is a modified version of the /header.php file from the parent theme (uw_wp_theme, v2.2.0).
 *
 * @link https://github.com/uweb/uw_wp_theme/blob/2.2.0/header.php
 *
...
<?php
$toggle_option = get_option( 'toggle_search_options' ) ? get_option( 'toggle_search_options' )['uw_toggle_options'] : 'uw';
?>
			...
			<form class="uw-search" data-sitesearch="<?php echo esc_url( home_url() ) . '/'; ?>" action="<?php echo ( 'uw' === $toggle_option ? 'https://uw.edu/search' : esc_url( home_url() ) . '/' ); ?>">
				<div class="search-form-wrapper">
					...
					<input id="uw-search-bar" type="search"
						name="<?php echo ( 'uw' === $toggle_option ? 'q' : 's' ); ?>"
...
?>
	<div id="page-inner">
			...
			<div class="navbar navbar-expand-lg">
				<div class="navbar-brand site-branding">
					<a href="https://www.washington.edu" title="University of Washington Home" tabindex="0">
						<img src="<?php echo get_theme_file_uri( 'assets/img/uw_logo.png' ); ?>" alt="University of Washington - Logo">
					</a>
				</div><!-- .site-branding -->

				<div id="site-navigation" class="main-navigation" aria-label="<?php esc_attr_e( 'Main menu', 'uw_wp_theme' ); ?>">
					<div id="search-quicklinks">
						<?php if ( ! get_option( 'search-hide' ) ) { ?>
		...
		<div id="main-navigation">
			<a href="<?php echo home_url(); ?>" title="UW MEM-C Home" tabindex="1">
				<img id='site-logo' src="<?php echo get_theme_file_uri( 'assets/img/uwmemc-subtext-logo.png' ); ?>" alt="UW MEM-C - Logo">
			</a>
