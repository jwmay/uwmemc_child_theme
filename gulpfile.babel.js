...
// Bundler JS related plugins.
const named = require( 'vinyl-named' ); // Give vinyl files arbitrary chunk names.
const webpack = require( 'webpack' ); // Bundle JavaScript files.
const webpackStream = require( 'webpack-stream' ); // Webpack integration with Gulp.
const wpWebpackConfig = require( '@wordpress/scripts/config/webpack.config' ); // WordPress webpack configuration.
 ...
 *     2. Bundles all the files using webpack and generates custom.js
 */
gulp.task( 'customJS', () => {
	const webpackConfig = {
		...wpWebpackConfig,
